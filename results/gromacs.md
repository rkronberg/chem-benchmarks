...
| Module        | Benchmark         | System | MPI ranks | Threads/rank | GPUs | Performance (ns/day) | Date       | Notes |
|---------------|-------------------|--------|-----------|--------------|------|----------------------|------------|-------|
...
| `2025.4-gpu`  | `gromacs-stmv.sh` | LUMI   | 8         | 7            | 4    | 109.055              | 2025-12-09 |
| `2025.4-gpu`  | `gromacs-adh.sh`  | LUMI   | 1         | 7            | 0.5  | 284.415              | 2025-12-09 |     
| `2026.0-gpu`  | `gromacs-stmv.sh` | LUMI   | 8         | 7            | 4    | 109.753              | 2026-02-05 | ROCm 6.3.4 |
| `2026.0-gpu`  | `gromacs-adh.sh`  | LUMI   | 1         | 7            | 0.5  | 292.813              | 2026-02-05 | ROCm 6.3.4 |
| `2026.0`      | `gromacs-stmv.sh` | LUMI   | 128       | 1            | 0    | 10.630               | 2025-02-05 |
| `2026.0`      | `gromacs-adh.sh`  | LUMI   | 128       | 1            | 0    | 146.828              | 2025-02-05 |
